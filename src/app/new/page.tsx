    ...
    const productData: Product[] = [
        {
            ...
            imageVar: "https://via.placeholder.com/40",
            marginTop: 324
        },
        {
            title: "B3 Face",
        ...
        <main className="overflow-x-hidden">
            ...
            <section className="w-full h-svh max-h-svh">
                <div className="flex flex-col justify-center">
                    ...
                    <div className="w-full text-[#000] text-[48px] text-center">
                        Products
                    </div>

                </div>

                <div className="flex justify-center space-x-[64px] pb-[px] w-full">
                    <div className="w-full h-[118px]" />
                    {productData.map((item, index) => (
                        <div
                            key={index}
                            className="bg-white/10 shadow-black/25 shadow-md backdrop-blur-2xl p-[94px] border border-white/10 border-r-[5px] rounded-lg"
                        >
                            <Image
                                src={B3_Serum_Gold}
                                alt="B3 Serum"
            ...
            <section className="flex justify-center pb-[80px] max-[1800px]:pb-[28px] max-[780px]:pb-[8px] w-full">
                    <Footer/>
            </section>
        </main>
    )
